        ...
        <div className="flex flex-col md:flex-row md:gap-14 border-b border-gray-300 pb-8">
          ...
          <div className="flex flex-col gap-2 md:text-xl">
            <p>
              ...
              desarrolladora web Frontend. Apasionada por la creación e
              implementación de diseños, desde un enfoque estético y funcional.
            </p>
            <p>
              Soy responsable y colaborativa, motivada a solucionar los
              problemas que se puedan presentar, adquiriendo nuevas habilidades
              y capacitándome constantemente para fortalecer mi trabajo.
            </p>
          </div>
        </div>
